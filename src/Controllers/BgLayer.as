...
package Controllers
{
	...
	public class BgLayer extends Sprite
	{
		...
		private function onAddedToStage(event:Event):void
		{
			...
			if (_layer == 1)
			{
				image1 = new Image(AssetsController.getTexture("BgLayer" + _layer));
				image1.blendMode = BlendMode.NONE;
				image2 = new Image(AssetsController.getTexture("BgLayer" + _layer));
				image2.blendMode = BlendMode.NONE;
			}
			else
			{
				image1 = new Image(AssetsController.getAtlas().getTexture("bgLayer" + _layer));
				image2 = new Image(AssetsController.getAtlas().getTexture("bgLayer" + _layer));
			}
